  ...
  const features = [
    {
      ...
      description:
        "Access all your local music files in one beautiful interface. Browse by songs, albums, artists, and playlists.",
    },
    {
      icon: Zap,
      title: "Lightning Fast",
      description:
        "Instant playback with no lag. Optimized performance ensures smooth experience even with large libraries.",
    },
    {
      icon: Shield,
      title: "Privacy First",
      description:
        "Zero data collection. Your music stays on your device. No tracking, no analytics, no compromises.",
    },
    {
      icon: Headphones,
      title: "Rich Playback",
      description:
        "Advanced equalizer, gapless playback, and support for all major audio formats including FLAC.",
    },
    {
      icon: Heart,
      title: "Smart Features",
      description:
        "Track your listening history, discover your most played songs, and get intelligent music suggestions.",
    },
    {
      icon: Code,
      title: "Open Source",
      description:
        "Built on RetroMusicPlayer. Fully transparent, community-driven, and licensed under GPL-3.0.",
    },
  ];
    ...
    <div className="landing-page">
      ...
      <section id="features" className="features-section">
        <div className="section-header">
          ...
          <p className="section-subtitle">
            Everything you need in a music player, nothing you don't
          </p>
        </div>
      ...
      <section className="screenshots-section">
        <div className="section-header">
          ...
          <p className="section-subtitle">
            A music player designed for music lovers
          </p>
        </div>
        ...
        <div className="privacy-content">
          <div className="privacy-text">
            ...
            <p className="privacy-description">
              Unlike streaming services that track your every move, Musicfy
              operates entirely on your device. No accounts, no cloud storage,
      ...
      <section id="download" className="download-section">
        <div className="download-content">
          ...
          <p className="download-note">
            Free • Open Source • No Ads • GPL-3.0 Licensed
          </p>
        </div>
      </section>
